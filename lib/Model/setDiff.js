...
function diffDeep(model, segments, before, after, group) {
  if (typeof before !== 'object' || !before ||
      (!Array.isArray(before) && !before.constructor.prototype.hasOwnProperty('isPrototypeOf')) ||
      typeof after !== 'object' || !after ||
      (!Array.isArray(after) && !after.constructor.prototype.hasOwnProperty('isPrototypeOf'))) {
