...
Model.prototype._dereference = function(segments, forArrayMutator, ignore, notInit) {
  ...
  do {
    ...
    for (var i = 0, len = segments.length; i < len; i++) {
      ...
      if (refList && refList !== ignore && (!refList.notInit || notInit)) {
